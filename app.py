...
def main():
	...
	gtml_temp = """
	<iframe width="560" height="315" src="https://www.youtube.com/embed/6Y2kLF1IKEs" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
	</div>
	"""
	...
	st.sidebar.title("Get the Machine Learning code of this application for education")
